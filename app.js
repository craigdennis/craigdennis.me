...
function slideleft() {
  if (parseInt(cross_slide.style.left) > actualwidth * -1 + 8) {
    ...
    cross_slide.style.left =
      parseInt(cross_slide2.style.left) + actualwidth + slideshowgap + 'px';
  }
  if (parseInt(cross_slide2.style.left) > actualwidth * -1 + 8) {
    cross_slide2.style.left =
      parseInt(cross_slide2.style.left) - copyspeed + 'px';
  } else {
    cross_slide2.style.left =
      parseInt(cross_slide.style.left) + actualwidth + slideshowgap + 'px';
  }
}
